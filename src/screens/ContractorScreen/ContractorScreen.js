        ...
        <>
            ...
            <View>
                ...
                <View>
                    ...
                    <Recipes name='Mozzarella sticks' price= '3.90' updateCart={updateShopCart} cart={shopCart}/>
                    <Recipes name='Salade verte' price= '2.00' updateCart={updateShopCart} cart={shopCart}/>
                </View>
                <Text style={styles.titre_section}>Plats</Text>
                <View>
                    <Recipes name='Saumon au beurre blanc' price= '17.50' updateCart={updateShopCart} cart={shopCart}/>
                    <Recipes name='Entrecôte XXL' price= '23.50' updateCart={updateShopCart} cart={shopCart}/>
                    <Recipes name='Caille farcie foie gras' price= '27.50' updateCart={updateShopCart} cart={shopCart}/>
                </View>
                <Text style={styles.titre_section}>Desserts</Text>
                <View>
                    <Recipes name='Brioche perdue' price= '7.50' updateCart={updateShopCart} cart={shopCart}/>
                    <Recipes name='Mille-feuilles' price= '7.50' updateCart={updateShopCart} cart={shopCart}/>
                    <Recipes name='Crème brulée' price= '7.50' updateCart={updateShopCart} cart={shopCart}/>
                </View>
                <Text style={styles.titre_section}>Boissons</Text>
                <View>
                    <Recipes name='Coca-Cola 33cl' price= '2.00' updateCart={updateShopCart} cart={shopCart} />
                    <Recipes name='Orangina 33cl' price= '2.00' updateCart={updateShopCart} cart={shopCart} />
                    <Recipes name='Ice-tea 33cl' price= '2.00' updateCart={updateShopCart} cart={shopCart} />
                </View>
